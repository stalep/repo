...
public class DataSetDTO {
    ...
    public void setRunId(int runId) {
        this.run = (Run)Run.getEntityManager().getReference(Run.class, runId);
    }
     */
    ...
    public DataSetDTO(RunDTO run, int ordinal, String description, JsonNode data) {
        this.runId = run.id;
    ...
    public static class EventNew {
        ...
        public EventNew(DataSetDTO dataset, boolean isRecalculation) {
